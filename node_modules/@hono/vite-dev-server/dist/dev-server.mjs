import { createBasePathGuard, createBasePathRewriter, safeParseUrlPath } from "./utils.mjs";
			...
			async function createMiddleware(server) {
				return async function(req, res, next) {
					...
					for (const pattern of exclude) if (req.url) {
						...
						} else if (minimatch(req.url?.toString(), pattern)) return next();
					}
					if (!shouldHandlePath(req.url ? safeParseUrlPath(req.url) : void 0)) return next();
					let loadModule;
...
//#endregion
export { defaultOptions, devServer };
